//
//  BYAlertController.swift
//  BYHelper
//
//  Created by ysq on 15/1/4.
...
public class BYAlertController: NSObject {
    ...
    init( title : String? , message : String?  ,preferredStyle : UIAlertControllerStyle , cancelButtonTitle : String? , otherButtonTitles : String? , _ moreButtonTitles : String?...) {
        ...
        if IOS7{
            ...
            self.setupInIOS7(title, message: message, preferredStyle: preferredStyle, cancelButtonTitle: cancelButtonTitle, otherButtonTitles: otherTitles)
    ...
    private func setupInIOS7(var title : String? ,var message : String?   ,preferredStyle : UIAlertControllerStyle , cancelButtonTitle : String? = "" , otherButtonTitles : [String] ){
